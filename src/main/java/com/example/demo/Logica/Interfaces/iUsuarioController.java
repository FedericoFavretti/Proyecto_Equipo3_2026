...
public interface iUsuarioController {
    ...
    ResponseEntity<DtUsuario> editarDatosDeCuentaDeUsuario(@RequestPart(value = "datos", required = false) DtActualizarPerfilRequest datos, @RequestPart(value = "foto", required = false) MultipartFile foto, @RequestHeader("Authorization") String authHeader, Authentication authentication);
